...
class UserModel(models.Model):
    ...
    auto_trading_status = models.CharField(max_length=3, default='0', verbose_name='자동 매매 활성화 상태')
...
class TradingHistoryModel(models.Model):
    ...
    roe = models.FloatField(null=True, verbose_name='수익률')  # roe : rate of return
